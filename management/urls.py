...
urlpatterns = [
    ...
    path('author/add/', views.AuthorCreateView.as_view(template_name="management/mgt_generic.html"), name='author-add'),
    path('publisher/add/', views.PublisherCreateView.as_view(template_name="management/mgt_generic.html"), name='publisher-add'),
